...
We've been working hard on a new implementation of the `dat` command-line tool. You can get try it out now (but don't forget to [let us know if things break](http://gitter.im/datproject/discussions)):
