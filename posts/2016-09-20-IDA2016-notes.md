...
* The first two sessions covered the costs, budgets, and revenue streams for data repositories.
* Repositories have a wide range of pricing and revenue structures (for details, see witness statements in link above).
* Library managers were concerned that they will be unable to pay for all the data repositories their researchers need access to.
* Costs are added onto the high costs institutions pay for journal subscriptions.
* Data can be published in several data repositories, with no common link between them. **As this happens to more data, it becomes unclear which repositories institutions should subscribe to.**
* Hosting and bandwidth for the data repositories amount to 1/4th to 1/3rd of their total costs.
...
* The last big chunk of spending was on software development. Unfortunately, repositories are duplicating costs by developing similar software.

### [Managing Science Data: A Federal Agency’s Perspective](http://www.scidatacon.org/2016/sessions/10/)

* This session featured the challenges faced by federal agencies around data management.
* Recent federal mandates have started to require open data and agencies are moving towards that goal. The papers from the session are worth a read because they provide a different perspective compared to academic researchers.
...
* The presenters made clear that open data is a public good, such as in cases like natural disaster prevention.
* However, they also made clear that it is unreasonable to say all research data must be totally open. Fully open data creates privacy concerns, IP issues, and technological hurdles.
* Making specific recommendations, such as around reproducibility of published results, can go a long way in supporting both the public good and research needs.
